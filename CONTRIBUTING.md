...
- Claim speed parity with Impeccable or aislop -- they're deterministic and near-instant; slop-eval's LLM-judge call is honestly slower, and the README states that tradeoff plainly.
