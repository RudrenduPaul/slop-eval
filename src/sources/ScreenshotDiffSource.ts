 ...
 *
 * Scope decision (locked at eng-review, 2026-07-13): this source ships as a
...
export class ScreenshotDiffSource implements RuleSource {
  name = 'screenshot-diff-vs-corpus';

  async score(_input: ScoreInput): Promise<RuleFinding[]> {
    return [
      {
        ...
        evidence:
          ...
          'produced. This is documented v0.1 scope (see eng-review, 2026-07-13), not a ' +
